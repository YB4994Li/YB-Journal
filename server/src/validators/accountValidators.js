...
export const accountRules = [
  ...
  body('maximumLossPercentage').optional({nullable:true,checkFalsy:true}).isFloat({gt:0,lte:100}),
  ...
  body('phases.*.status').if(body('accountType').equals('FUNDED')).isIn(['LOCKED', 'ACTIVE', 'PASSED', 'FAILED', 'ARCHIVED']),
